        ...
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<?php echo e(route('admin.dashboard')); ?>"
                        class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">Admin Dashboard</a></li>
                <li><a href="<?php echo e(route('admin.users.index')); ?>"
                        class="<?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">Users</a></li>
            </ul>
...
</html><?php /**PATH C:\EverythingX\ERP\resources\views/components/admin-layout.blade.php ENDPATH**/ ?>